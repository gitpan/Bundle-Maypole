# This Makefile is for the Bundle::Maypole extension to perl.
#
...
#     NAME => q[Bundle::Maypole]
#     VERSION_FROM => q[Maypole.pm]
...
FULLEXT = Bundle/Maypole
BASEEXT = Maypole
PARENT_NAME = Bundle
DLBASE = $(BASEEXT)
VERSION_FROM = Maypole.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
...
TO_INST_PM = Maypole.pm

PM_TO_BLIB = Maypole.pm \
	$(INST_LIB)/Bundle/Maypole.pm
...
DISTNAME = Bundle-Maypole
DISTVNAME = Bundle-Maypole-0.01
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3pm --perm_rw=$(PERM_RW)\
	  Maypole.pm $(INST_MAN3DIR)/Bundle::Maypole.$(MAN3EXT) 
...
realclean purge ::  clean realclean_subdirs
	...
	$(RM_RF) $(DISTVNAME)
	$(RM_F)  $(INST_LIB)/Bundle/Maypole.pm $(MAKEFILE_OLD) $(FIRST_MAKEFILE)
...
metafile :
	...
	$(NOECHO) $(ECHO) 'name:         Bundle-Maypole' >> META.yml
	$(NOECHO) $(ECHO) 'version:      0.01' >> META.yml
	$(NOECHO) $(ECHO) 'version_from: Maypole.pm' >> META.yml
...
pm_to_blib: $(TO_INST_PM)
	$(NOECHO) $(PERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')'\
	  Maypole.pm $(INST_LIB)/Bundle/Maypole.pm 
	$(NOECHO) $(TOUCH) $@
